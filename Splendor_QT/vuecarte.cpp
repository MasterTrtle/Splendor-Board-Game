...
*/
    ...
    if (isChecked()) { // si la carte est sélectionnée, on ajoute une croix noire
         painter.drawText(QRect(15,50,100,60), Qt::AlignCenter, tr("Carte \n Sélectionne \n"));
    }
